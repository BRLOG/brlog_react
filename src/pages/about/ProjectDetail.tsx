...
const projectsData = {
    'brlog': {
        ...
        period: '2025.03 - ',
        thumbnail: '/src/assets/img/projects/brlog-thumbnail.png',
        ...
        images: [
            '/src/assets/img/projects/brlog-1.png',
            '/src/assets/img/projects/brlog-2.png',
            '/src/assets/img/projects/brlog-3.png',
            '/src/assets/img/projects/brlog-4.png',
            '/src/assets/img/projects/brlog-5.png',
            '/src/assets/img/projects/brlog-6.png',
            '/src/assets/img/projects/brlog-7.png',
        ],
    ...
    'kkobok': {
        ...
        thumbnail: '/src/assets/img/projects/kkobok-thumbnail.png',
        ...
        images: [
            '/src/assets/img/projects/kkobok-1.png',
            '/src/assets/img/projects/kkobok-2.png'
        ],
    ...
    'smart-refrigerator': {
        ...
        thumbnail: '/src/assets/img/projects/smart-fridge-thumbnail.png',
        github: '',
        ...
        images: [
            '/src/assets/img/projects/smart-fridge-1.png',
            '/src/assets/img/projects/smart-fridge-2.png',
            '/src/assets/img/projects/smart-fridge-3.png',
            '/src/assets/img/projects/smart-fridge-4.png',
            '/src/assets/img/projects/smart-fridge-5.png',
            '/src/assets/img/projects/smart-fridge-6.png',
        ],
    ...
    'tetris': {
        ...
        thumbnail: '/src/assets/img/projects/tetris-thumbnail.png',
        video: '/src/assets/img/projects/tetris-video.mp4',
        github: '',
        ...
        images: [
            '/src/assets/img/projects/tetris-1.png',
            '/src/assets/img/projects/tetris-2.png',
            '/src/assets/img/projects/tetris-3.png',
        ],
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {project.images.map((img, idx) => (
                        <img
                            ...
                            className="w-full object-contain h-[300px] rounded-lg shadow-md"
